 ...
 *         Date: 2024-03-07
 * 
 *         VoicePlan is an extension of the item class and 1/2 of the Plan
 *         objects. Cost is calculated by mulitplying the costPer30Days by the
...
public class VoicePlan extends Item {
	...
	public VoicePlan(String itemCode, String name, Double pricePer30Days, String phoneNumber, Integer daysPurchased) {
	...
	public VoicePlan(String itemCode, String name, int itemId, String phoneNumber, Integer daysPurchased,
			double pricePer30Days, int saleItemId) {
		super(itemCode, name, itemId);
		this.phoneNumber = phoneNumber;
		this.daysPurchased = daysPurchased;
		this.pricePer30Days = pricePer30Days;
